...
> **Propósito:** Desenvolvido durante um **Hackathon** com foco em automação e experiência do usuário.  
...
- Construção de dataset com 30 consultas simuladas e *features* baseadas em BM25.  
- Treinamento de modelo **LambdaMART** via LightGBM, avaliando desempenho com NDCG@10.  
